...
import com.example.maichel.submission2.main.MatchesList.MatchesActivity.Adapter.LastMatchAdapter
 ...
 *
 */
class Last15Match : Fragment(), AnkoComponent<Context>, MainView {

    private var teams: MutableList<MatchEvent> = mutableListOf()
    private lateinit var presenter: MainPresenter
    private lateinit var adapterMatchAdapter: LastMatchAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapterMatchAdapter = LastMatchAdapter(teams) {
        ...
        listTeam.adapter = adapterMatchAdapter
    ...
    override fun showMatchList(data: List<MatchEvent>) {
        ...
        teams.clear()
        teams.addAll(data)
        adapterMatchAdapter.notifyDataSetChanged()
    }
